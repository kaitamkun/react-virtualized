...
export type CellRenderer = (props: CellRendererParams) => ReactElement<*>;

export type CellCache = {[key: string]: ReactElement<*>};
...
export type NoContentRenderer = () => ReactElement<*> | null;
