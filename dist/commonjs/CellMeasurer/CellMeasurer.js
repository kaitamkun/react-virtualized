...
CellMeasurer.propTypes = process.env.NODE_ENV === 'production' ? null : {
  ...
  children: require('prop-types').oneOfType([require('prop-types').func, typeof ReactElement === 'function' ? require('prop-types').instanceOf(ReactElement) : require('prop-types').any]).isRequired,
